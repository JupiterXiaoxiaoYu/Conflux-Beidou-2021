...
class App extends React.Component {
    constructor(props) {
        ...
        USTD:'0xb8cFD14a5B9d376BF4da8e845d3AeA8111934B3f',COP:'0x6f991a46d5aBBE8E9ae9Ef0d411E980f34ba1e78', price:100 };
    }
...
class Buyer extends Player {
    ...
    async getPrice() {
        this.setState({view:'getPrice'})
        return this.props.price;
    }

    async getToken() {
        return this.props.COP
    }
